<div class="admin-page__content-form">
  ...
  <form class="admin-form" method="POST" action="<?php echo HOST;?>admin/category-blog-delete/<?php echo u($category->getId()); ?>">
    ...
    <div class="admin-form__buttons buttons">
      ...
      <a class="button button--outline button--s" href="<?php echo HOST . 'admin/category-blog';?>">Отмена</a>
    </div>
  </form>
</div>

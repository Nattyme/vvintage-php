<div class="cart__grid cart__grid--relative">
  <div class="cart__row">
    <a 
      href="<?php echo HOST . 'removefromfav?id=' . u($product->getId());?>" 
    ...
    <div class="cart__img">
      <img 
        src="<?php echo HOST;?>usercontent/products/<?php echo empty($mainImage->getFilename()) 
        ? "no-photo.jpg" : h($mainImage->getFilename());?>" 

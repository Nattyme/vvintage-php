...
<head>
  ...
  <title><?php echo (isset($seo) && !empty($seo->meta_title)) ? h($seo->meta_title) : h($seo->title) ?? ''; ?></title>
  ...
  <!-- SEO: description -->
  <meta name="description" content="<?php echo (isset($seo) && !empty($seo->meta_description)) ? h($seo->meta_description) : h($seo->description) ?? ''; ?>">
